    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[25%] w-[50%] rounded-2xl absolute bottom-30 left-1/2 -translate-x-1/2 p-3">
          ...
          <br />
          <br />
          <TypewriterText className="p-4" text='Oh and I´ll leave your razor on your desk, I cleaned it.' speed={50}/>
          <button onClick={() => navigate('/Take49')} className="h-[20%] w-[10%] bg-blue-400 rounded-xl absolute bottom-4 right-4">Next</button>
      </div>
