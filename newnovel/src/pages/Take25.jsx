    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[35%] w-[50%] rounded-2xl absolute bottom-30 left-1/2 -translate-x-1/2 p-3">
            ...
            <br />
            <br />
            <TypewriterText className="p-4" text='With the bathroom back to normal, I went to the laundry to leave his pajamas in a mix of products to get the blood stain off, I hope it works thought, I never did it before but there´s a first time for everything.' speed={50}/>
            <button onClick={() => navigate('/Take26')} className="h-[15%] w-[10%] bg-blue-400 rounded-xl absolute bottom-4 right-4">Next</button>
        </div>
      </div>
    </div>
  );
