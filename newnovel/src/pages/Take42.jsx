    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[35%] w-[50%] rounded-2xl absolute bottom-30 left-1/2 -translate-x-1/2 p-3">
            ...
            <br />
            <br />
            <TypewriterText className="p-4" text=' I lifted his head and put him laying on top of my legs, he started crying again but it was different, this time, he was lighter, opening himself to me in such a sensitive moment.' speed={50}/>
