    ...
    >
      <div className="h-[90%] w-[90%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[40%] w-[80%] rounded-2xl absolute bottom-15 left-1/2 -translate-x-1/2 p-3">
            ...
            <br />
            <br />
            <TypewriterText className="p-5" text="I gave him a kiss on his forehead, he gave me a tiny smile in response. I watched him going to his room limping a little, his legs must hurt a bit to walk." speed={50}/>
