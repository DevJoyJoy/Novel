    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[35%] w-[50%] rounded-2xl absolute bottom-30 left-1/2 -translate-x-1/2 p-3">
            ...
            <br />
            <br />
            <TypewriterText className="p-4" text='I grabbed a wet towel to clean his open cuts, the blood was starting to get dried around the corners, I stared at him, asking for permission to start to guarantee that he was okay with everything. ' speed={50}/>
            <button onClick={() => navigate('/Take19')} className="h-[12%] w-[10%] bg-blue-400 rounded-xl absolute bottom-4 right-4">Next</button>
        </div>
      </div>
    </div>
  );
