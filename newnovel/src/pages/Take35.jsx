  ...
  return (
    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-start items-center">
        <img className="h-[88%] self-end pl-4" src="/Kokichi/kokichi_serious.webp" alt="" />
        <div className="bg-violet-300 h-[30%] w-[50%] rounded-2xl absolute bottom-30 left-1/2 -translate-x-1/2 p-3">
            ...
            <TypewriterText className="p-4" text='Around a year, I guess.' speed={50}/>
            <button onClick={() => navigate('/Take36')} className="h-[15%] w-[10%] bg-violet-400 rounded-xl absolute bottom-4 right-4">Next</button>
        </div>
      </div>
    </div>
  );
