    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[40%] w-[50%] rounded-2xl absolute bottom-30 left-1/2 -translate-x-1/2 p-3">
            ...
            <br />
            <br />
            <TypewriterText className="p-4" text='I wanted to speak, to say something to him, but nothing could take his pain away, and seeing him laying on my lap just made me realise that he just needed some support, someone to make him feel...seen, to feel like he is not alone when everything feels like hell.' speed={50}/>
            <button onClick={() => navigate('/Take44')} className="h-[12%] w-[10%] bg-blue-400 rounded-xl absolute bottom-4 right-4">Next</button>
        </div>
      </div>
    </div>
  );
