    ...
    >
      <div className="h-[90%] w-[90%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[40%] w-[80%] rounded-2xl absolute bottom-15 left-1/2 -translate-x-1/2 p-3">
            ...
            <br />
            <br />
            <TypewriterText className="p-5" text="You don't have to take it alone, I'm here." speed={50}/>
            <button onClick={() => navigate('/Take13')} className="h-[15%] w-[10%] bg-blue-400 rounded-xl absolute bottom-4 right-4">Next</button>
        </div>
