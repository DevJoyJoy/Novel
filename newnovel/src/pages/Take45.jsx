    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[35%] w-[50%] rounded-2xl absolute bottom-30 left-1/2 -translate-x-1/2 p-3">
          ...
          <br />
          <br />
          <TypewriterText className="p-4" text='But on top of everything, I need to fix this, tk be by his side from now on, just because I couldn´t do it before doesn´t mean I can´t do it now.' speed={50}/>
