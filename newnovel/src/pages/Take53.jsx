  ...
  return (
    ...
    >
      <div className="h-[90%] w-[90%] bg-blue-950 flex flex-row justify-end items-center">
        <div className="bg-blue-300 h-[40%] w-[580%] rounded-2xl absolute bottom-15 left-1/2 -translate-x-1/2 p-3">
          <p className="text-3xl h-[20%] w-[30%] bg-blue-400 rounded-2xl absolute top-2 right-2 m-1.5 p-1">Shuichi Saihara</p>
          <br />
          <br />
          <TypewriterText className="p-5" text='Your idiot.' speed={50}/>
          <button onClick={() => navigate('/Finale')} className="h-[15%] w-[10%] bg-blue-400 rounded-xl absolute bottom-4 right-4">Next</button>
      </div>
