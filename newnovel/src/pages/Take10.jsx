    ...
    >
      <div className="h-[70%] w-[60%] bg-blue-950 flex flex-row justify-start items-center">
        <img className="h-[88%] self-end pl-4" src="/Kokichi/kokichi_cry.webp" alt="" />
            ...
            <TypewriterText className="p-4" text=' I just can´t take it anymore, it´s too much for me to handle alone!' speed={50}/>
            <button onClick={() => navigate('/Take11')} className="h-[17%] w-[10%] bg-violet-400 rounded-xl absolute bottom-4 right-4">Next</button>
        </div>
      </div>
    </div>
  );
